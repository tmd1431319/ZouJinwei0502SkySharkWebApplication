...
namespace ZouJinwei0502SkySharkWebApplication.LOB
{
    public partial class QueryStat : System.Web.UI.Page
    {
        ...
        protected void btnFStatSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                lblTicketStatus.Text = "Invalid flight number";
                return;
            }
            else
            {
                ...
                if (flightStatus)
                {
                    ...
                    {
                        lblTicketStatus.Text = "Status: Available";
                        ;
                    }
                    else
                    {
                        ...
                        {
                            lblTicketStatus.Text = "Status: Overbooked";
                        }
                    }
                }
                else
                {
                    lblTicketStatus.Text = "Status: Not Available";
                }
            }//end else
        }
