...
namespace ZouJinwei0502SkySharkWebApplication.LOB
{
    public partial class CreateRes : System.Web.UI.Page
    {
        ...
        protected void Wizard1_NextButtonClick(object sender, WizardNavigationEventArgs e)
        {
            if (Wizard1.WizardSteps[e.CurrentStepIndex].ID.ToString().Trim() == "WizardStep1")
            {
                ...
                cmd.Parameters.AddWithValue("@FltNo", txtFltNum.Text.Trim());
                ...
                {
                    if (myRow[0].ToString().Trim().ToLower() == txtFltNum.Text.ToLower())
                    {
                        exists = true;
                    ...
                    FltStatuscmd.Parameters.AddWithValue("@FltNo", txtFltNum.Text.Trim());
                    ...
                    if (FltStatusdataSet.Tables["FltStatus"].Rows.Count == 0)
                    {
                        ...
                        foreach (DataRow myRow in dataSet.Tables["FltDetails"].Rows)
                        {
                            if (myRow[0].ToString().Trim().ToLower() == txtFltNum.Text.ToLower())
                            {
                                ...
                                insertSatatusSqlcmd.Parameters.AddWithValue("@StatusDate", DateOfJourney);
        ...
        protected void Wizard1_FinishButtonClick(object sender, WizardNavigationEventArgs e)
        {
            if (Wizard1.WizardSteps[e.CurrentStepIndex].ID.ToString().Trim() == "WizardStep3")
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@ReservedBy", "Admin");
                    cmd.Parameters.AddWithValue("@DateOfRes", DateOfRes);
                    cmd.Parameters.AddWithValue("@TicketConfirmed", Convert.ToBoolean(0));
